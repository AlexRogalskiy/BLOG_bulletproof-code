  ...
  return (
    <MainLayout page="Terms & Conditions">
      <article className="text-page max-w-prose mx-auto">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Bulletproof Code.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Bulletproof Code, accessible
              from{" "}
              <a
                href="https://bulletproof-code.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://bulletproof-code.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: will@bulletproof-code.com</li>
        </ul>
      </article>
    </MainLayout>
  );
